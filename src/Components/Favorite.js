...
const Favorite = () => {
  const fav = localStorage.getItem("ptFav")?.split(",");
  ...
  function handleRemove(id) {
    ...
    const getFavData = localStorage.getItem("ptFav").split(",");
    const favProId = getFavData.indexOf(id);
      ...
      <div className="main-container">
        ...
        {fav ? (
          <div className="main-container-body">
            {fav.map((idd) => {
              return favData
                .filter((fFav) => fFav._id === idd)
                .map((fav, i) => {
                  return (
                    <div className="display-item" key={fav._id}>
                      <div className="item-img">
                        <img
                          src={require("../uploads/productsImages/" +
                            fav.image)}
                          alt={fav.type}
                        />
                      </div>
